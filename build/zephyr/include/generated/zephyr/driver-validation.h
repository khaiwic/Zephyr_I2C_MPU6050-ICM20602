...
#define K_SYSCALL_DRIVER_PULSE_IO(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, pulse_io, PULSE_IO)
...
#define K_SYSCALL_DRIVER_DEVMUX(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, devmux, DEVMUX)
